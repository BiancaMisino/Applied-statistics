setwd("C:/Users/sarar/Desktop/POLI/APPLIED STATISTIC/Project/Applied-statistics-main4")
...
confint(best.fit, level=0.95)

#Odds ratio
odds.ratio<-matrix(NA,1,best.fit$rank-1)
odds.ratio<-exp(best.fit$coefficients)
odds.ratio
